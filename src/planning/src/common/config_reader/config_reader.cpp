...
namespace Planning
{
    ...
    void ConfigReader::read_vehicle_config(VehicleStruct &vehicle, const std::string &name)
    {
        ...
        vehicle.x_ = planning_config["vehicle"][name]["x"].as<double>();
        vehicle.y_ = planning_config["vehicle"][name]["y"].as<double>();
        vehicle.pose_theat_ = planning_config["vehicle"][name]["pose_theta"].as<double>();
    ...
    void ConfigReader::read_vehicle_config()
    {
        try
        {
            ...
            read_vehicle_config(obs_, "obs");
        }
        catch(const YAML::Exception &e)
        {
            RCLCPP_INFO(rclcpp::get_logger("config"), "Failed to load vehicle config: %s",e.what());
        }
    }
    ...
    void ConfigReader::read_pnc_map_config()
    {
        try
        {
            ...
            pnc_map_.road_length_ = planning_config["pnc_map"]["type"].as<double>();
        ...
        {
            RCLCPP_INFO(rclcpp::get_logger("config"), "Failed to load pnc_map config: %s",e.what());
        }
    }
    ...
    void ConfigReader::read_global_path_config()
    {
        ...
        {
            RCLCPP_INFO(rclcpp::get_logger("config"), "Failed to load global_path config: %s",e.what());
    ...
    void ConfigReader::read_reference_line_config()
    {
        try
        {
            ...
            refer_line_.front_size_ = planning_config["reference_line"]["front_size"].as<double>();
            refer_line_.back_size_ = planning_config["reference_line"]["back_size"].as<double>();

        }
        catch(const YAML::Exception &e)
        {
            RCLCPP_INFO(rclcpp::get_logger("config"), "Failed to load reference_line config: %s",e.what());
        }
    ...
    void ConfigReader::read_local_path_config()
    {
        ...
        {
            RCLCPP_INFO(rclcpp::get_logger("config"), "Failed to load local_path config: %s",e.what());
        }
    }
    ...
    void ConfigReader::read_local_speeds_config()
    {
        ...
        {
            RCLCPP_INFO(rclcpp::get_logger("config"), "Failed to load local_speeds config: %s",e.what());
        }
    }
    ...
    void ConfigReader::read_decision_config()
    {
        ...
        {
            RCLCPP_INFO(rclcpp::get_logger("config"), "Failed to load decision config: %s",e.what());
        }
    }
    ...
    void ConfigReader::read_planning_process_config()
    {
        ...
        {
            RCLCPP_INFO(rclcpp::get_logger("config"), "Failed to load planning_process config: %s",e.what());
        }
    }
    ...
    void ConfigReader::read_move_cmd_config()
    {
        ...
        {
            RCLCPP_INFO(rclcpp::get_logger("config"), "Failed to load move_cmd config: %s",e.what());
        }
    }
} // namespace planning
